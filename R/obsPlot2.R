...
#' @param plotByCol Define the column name to separate plots (typically a gene ID column).
#' @param groupCol Define the column name to group boxplots by (typically a replicate group column).
#' @param valueCol Define the column of values for plotting (typically a log intensity measure).
