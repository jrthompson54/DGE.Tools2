...
saveRDS## Load project from Omicsoft S3 bucket  
...
dgeObj_FromStash <- resetDGEobj(dgeObj)
...
There's one column we'll rename in the Xpress design table to be consistent with
the column name in the Omicsoft data.
